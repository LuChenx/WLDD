...
<body>
	...
	<br>
	 <div class="form row">  
            <form class="form-horizontal col-sm-offset-3 col-md-offset-3" id="register_form" action="<%=basePath%>register.do" method="post">   
                <div class="col-sm-9 col-md-9">  
                    ...
                    <div class="form-group">  
                        <input type="submit" class="btn btn-success pull-right" value="注册成为卖家"/>  
