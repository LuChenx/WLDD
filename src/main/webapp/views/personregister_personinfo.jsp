...
<body>
	...
	<ol class="breadcrumb">
		<li><a href="<%=basePath%>/views/personregister.jsp">账号信息填写</a></li>
		<li><a href="#">个人信息填写</a></li>
	</ol>
	<br>
	
	<div class="form row">  
            <form class="form-horizontal col-sm-offset-3 col-md-offset-3" id="register_form" action="<%=basePath%>registerPUserInfo.do" method="post">   
                <div class="col-sm-9 col-md-9">  
                    ...
                    <div class="form-group">  
                        <input type="submit" class="btn btn-success pull-right" value="完成"/>  
